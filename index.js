...
async function run() {
    try {
        ...
        app.put('/coffee/:id',async(req,res)=>{
          ...
          const coffee={
            $set:{
              name:updatedCoffee.name, quantity:updatedCoffee.quantity, supplier:updatedCoffee.supplier,
               taste:updatedCoffee.taste, category:updatedCoffee.category, details:updatedCoffee.details
...
app.get('/', (req, res) => {
    res.send("simple serverrr is running")
})
app.listen(port, () => {
